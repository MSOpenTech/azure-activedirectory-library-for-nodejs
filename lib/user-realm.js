...
function UserRealm(callContext, userPrinciple, authority) {
  ...
  // urn:federation:MicrosoftOnline as default value
  // urn:federation:partner.microsoftonline.cn 
  this._cloud_audience_urn = "urn:federation:MicrosoftOnline";
}
...
/**
* If the account is federated this will contain the Uniform Resource Name.
* @type {string}
* @instance
* @memberOf UserRealm
* @name cloud_audience_urn
*/
Object.defineProperty(UserRealm.prototype, 'cloud_audience_urn', {
  get : function() {
    return this._cloud_audience_urn;
  }
});
...
UserRealm.prototype._parseDiscoveryResponse = function(body, callback) {
  ...
  if (this._accountType === AccountType.Federated) {
    ...
    this._cloud_audience_urn = response['cloud_audience_urn'];
  }
